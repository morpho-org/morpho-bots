...
/**
 * The wire id for a liquidation opportunity: `midnight:liq:<chainId>:<marketId>:<borrower>` with both
 * hex values lowercased. Self-describing, pasteable into `act` bare, and the opaque dedupe label the
