...
// Slippage for the Pendle PT → underlying unwrap hop; a property of the unwrapper, not a venue knob
// (SLIPPAGE_BPS applies to the downstream venue sell). Keep well under MAX_ROUTE_IMPACT_BPS — it
// also haircuts the amount the downstream venue sells.
