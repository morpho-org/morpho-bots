 ...
 * a source XOR a transform; the CLI surfaces each as its own `blue <op>` command.
 * `unhealthy-positions` is the source; `liquidate` is the transform that consumes it. The CLI
 * dispatches this table directly.
 */
