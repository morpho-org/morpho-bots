...
export const TEMPORARY_BUILD_PREFIX = 'quoter-bot-playground-dist-'
export const CANONICAL_STAGING_PREFIX = 'quoter-bot-playground-staging-'
export const BUILD_OUTPUT_KIND = 'quoter-bot-playground-build'
