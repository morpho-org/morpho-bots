...
| `PRIORITY_FEE_GWEI`                 | `setup.priorityFeeGwei`               | Required positive integer in write mode. Initial priority fee; must leave replacement headroom below `MAX_FEE_GWEI`.                                                                                         |
