...
[TIB-2026-07-27](../../../docs/decisions/TIB-2026-07-27-midnight-quoter-bot-bot.md) and the
...
```sh
bun test bots/quoter-bot/test
bun run --filter @morpho-org/quoter-bot test:e2e
bun run --filter @morpho-org/quoter-bot typecheck
