 ...
 * @returns One record per failed check, and a terminating cycle record carrying overall readiness.
 ...
 * is emitted. Readiness itself is not a separate record: `cycle.completed` already carries it as
