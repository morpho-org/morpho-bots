...
- **Which venue** clears a given liquidation is chosen automatically. Aggregators are enabled by the
  ...
  curve, which is then interpolated at the actual seize size. This probe is **gated** to pairs that have a liquidatable position and
