...
/**
 * `warn` marks a reason that should not happen — `no_debt`/`healthy` negate `isLiquidatable`, and a
 * non-reverting zero oracle price is a market anomaly — so the line reads as a live assertion.
 */
