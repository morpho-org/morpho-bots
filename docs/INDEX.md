...
- [TIB-2026-08-04: Extract quoter-bot shared packages](./decisions/TIB-2026-08-04-extract-quoter-bot-shared-packages.md) — four standalone workspace packages extracted from the quoter bot (`@repo/logging`, `@repo/observability`, `@repo/monitoring`, `@repo/offers`), deliberately not folded into `@repo/bot-kit`/`@repo/utils`; behavior-preserving, with the observability error-name projection now injected
