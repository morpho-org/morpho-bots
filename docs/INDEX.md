...
- [TIB-2026-09-10: Quoter operator maker and delegated KMS signer](./decisions/TIB-2026-09-10-quoter-operator-maker-kms-signer.md) — separates the dedicated operator-held funded maker from a delegated KMS offer signer; a reduced Lambda signs canonical offer trees and known-root cancellations, while an unprivileged gas-only EOA publishes payloads — proposed
