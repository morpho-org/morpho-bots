...
- [TIB-2026-08-04: Extract market-making shared packages](./decisions/TIB-2026-08-04-extract-market-making-shared-packages.md) — four standalone workspace packages extracted from the market-making bot (`@repo/logging`, `@repo/observability`, `@repo/monitoring`, `@repo/offers`), deliberately not folded into `@repo/bot-kit`/`@repo/utils`; behavior-preserving, with the observability error-name projection now injected
