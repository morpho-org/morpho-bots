...
| ------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------- |
| [quoter-signer](../services/quoter-signer/) | KMS signing policy middleware Lambda image (v1 intent surface, superseded by TIB-2026-09-10) | [README](../services/quoter-signer/README.md) |
...
- [TIB-2026-09-10: Quoter operator maker and delegated KMS signer](./decisions/TIB-2026-09-10-quoter-operator-maker-kms-signer.md) — separates the dedicated operator-held maker from a gas-funded KMS signer that the bot uses directly with full Midnight authorization — proposed
